...
const bigVariation={
    ...
    return(
        <div id="videos">
            ...
            <Typography variant="h3" id="videos" className="text-center"> <Link href="https://www.youtube.com/@Aaghum" className="text-black">Like</Link> My Latest Songs</Typography>
            </MotionDiv>
