...
export default function Hero(){
    ...
    <MotionDiv initial={{x:20,opacity:0}}  whileInView={{x:0,opacity:1}} viewport={{once:false}} transition={{ease:"linear",delay:0.5,duration:1}} className="px-3 justify-self-center lg:justify-self-end">
        <div className="  lg:h-[450px] lg:w-[450px] h-[350px] w-[350px] relative rounded-full lg:rounded-2xl overflow-hidden grid place-items-center" > 
<Image src="/ephin.webp" alt="picture of Ephin" className="h-full w-full rounded-full" fill priority quality={100}/>
        </div>
    </MotionDiv>
        </div>
    )
